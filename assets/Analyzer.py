...
def summarizer(prompt, summarize_threshold=100):
    ...
    try:
        while True:
            ...
            print("len_transcript: ", len_transcript, "   words_summarized: ", words_summarized)
...
if __name__ == "__main__":
    summarizer("We introduce CLASS TLDR NOTES generation, a new form of extreme summarization of error-prone transcripts of a lecture for a student who isn't listening. CLASS TLDR NOTES generation involves high source compression, removes stop words and summarizes the transcript whilst retaining meaning and insight. The result is the shortest possible note (approx. 3-5 points) that retains all of the original meaning and context of the transcript. The speaker is a teacher.\n\nParagraph:\n\n[TRANSCRIPT]\n\nCLASS TLDR NOTES: ")